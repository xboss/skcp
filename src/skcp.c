...
int skcp_pack(skcp_conn_t* conn, skcp_pkt_t* pkt, unsigned char* out, size_t* out_len) {
    return 0;
}
int skcp_unpack(skcp_conn_t* conn, const unsigned char* in, size_t in_len, skcp_pkt_t* pkt) {
    return 0;
}
